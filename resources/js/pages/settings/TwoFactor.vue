...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <PageShell
            title="Two-factor authentication"
            description="Manage additional sign-in protection and recovery access."
            content-class="gap-6"
        >
            <SettingsLayout>
                <PagePanel body-class="space-y-6 p-6">
                    <template #header>
                        <div class="space-y-1">
                            <h2
                            ...
                            <p class="text-sm text-muted-foreground">
                                Turn two-factor authentication on or off and
                                manage how recovery works.
                            </p>
                        </div>
                    </template>
