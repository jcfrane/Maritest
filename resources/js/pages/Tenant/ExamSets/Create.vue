...
import {
    ...
    store as examSetsStore,
} from '@/routes/tenant/exam-sets';
import type { BreadcrumbItem } from '@/types';
import type { ExamSetQuestionnaire } from '@/types/exam-set';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Exam Set', href: examSetsCreate.url(slug) },
];
...
function submit(): void {
    form.post(examSetsStore.url(slug));
}
</script>

<template>
    <Head :title="`${tenant?.name} - Create Exam Set`" />

    <TenantLayout :breadcrumbs="breadcrumbs">
        <PageShell
            title="Create Exam Set"
            description="Name the exam set, decide its status, and choose the published questionnaires it should include."
            content-class="gap-6"
        >
            <form
                    ...
                    <PagePanel body-class="space-y-6 p-6 md:p-8">
                        <template #header>
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Keep the initial setup light and focused on
                                    the reusable bundle.
                                </p>
                            </div>
                        </template>
                        ...
                        <div class="grid gap-2">
                            ...
                            <p class="text-xs text-muted-foreground">
                                Published exam sets must include at least one
                    ...
                    <PagePanel body-class="space-y-4 p-6">
                        <template #header>
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Only published questionnaires are available
                                    for reuse here.
                                </p>
                            </div>
                        </template>
                        ...
                        >
                            ...
                            <p class="mt-1 text-sm text-muted-foreground">
                                Publish a questionnaire first, then return here
                                to add it.
                            </p>
                        </div>
                ...
                >
                    <template #header>
                        <div class="space-y-1">
                            ...
                            <p class="text-sm text-muted-foreground">
                                The order here becomes the order used by the
                                exam set.
                            </p>
                        </div>
                    </template>
                    ...
                    >
                        ...
                        <p class="mt-1 text-sm text-muted-foreground">
                            Add one or more published questionnaires from the
                            list on the left.
                        </p>
                    </div>
